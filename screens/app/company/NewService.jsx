...
const NewService = () => {
   ...
   const [currentImage, setCurrentImage] = useState(
      "https://static.vecteezy.com/system/resources/previews/011/801/482/original/eps10-grey-customer-service-desk-or-reception-icon-isolated-on-white-background-information-counter-symbol-in-a-simple-flat-trendy-modern-style-for-your-website-design-logo-and-mobile-app-vector.jpg"
   );
   ...
   return loading ? (
      ...
      >
         <View
            ...
            style={{ paddingBottom: bottomHeight + 12 }}
            gap={32}
         >
            <Text
               ...
               {value?.indefinite === false && (
                  <Col gap={8}>
                     ...
                     <Text className="text-[#A1A1AA]">
                        Define un precio a tu servicio.
                     </Text>
                  </Col>
               )}
            </Col>
            ...
            <TouchableOpacity
               ...
               className="bg-[#364670] py-3 rounded-lg"
            >
               <Text
