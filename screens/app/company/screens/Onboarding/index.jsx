...
import { CheckCompany, GetStatus } from "./funcs";
import { disabled_reasonMap, statusMap } from "./Maps";
...
const OnboardingScreen = () => {
   ...
   const handleInformation = () => {
      navigation.navigate("InformationVerify", {
         data: companyData?.activity?.requirements?.currently_due,
      });
   };
         ...
         <View className="flex flex-col" style={{ rowGap: 22 }}>
            ...
            <ComponentGroup title="Capacidades">
               ...
               <ComponentLabel
                  ...
                  value={
                     statusMap[companyData.activity.capabilities.transfers] ||
                     "Desactivado"
                  }
               />
            </ComponentGroup>
